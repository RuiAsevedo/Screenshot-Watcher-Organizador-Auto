# Screenshot-Watcher-Organizador-Auto
Automatização com small script em Python, para organizar e agilizar buscas de imagens do printscreen (printadas)
...
Os arquivos completos estão em screenshot_watcher_wayland.py e screenshot_watcher_area_wayland.py neste repositório. Copia o conteúdo de lá se for repetir o processo.
...
Configurações → Teclado → Ver e personalizar atalhos → Capturas de tela.
Vão aparecer entradas como "Salvar uma captura de tela em Imagens" e "Mostrar a interface de captura de tela", já associadas ao Print Screen e possivelmente ao Shift+Print Screen.
Clica em cada uma e aperta Backspace pra limpar o atalho.
